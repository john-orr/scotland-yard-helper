...
public enum Location {
    ...
    _13(13, Arrays.asList(4, 14, 23, 24), Arrays.asList(14, 23, 52), Arrays.asList(46, 67, 89)),
    _14(14, Arrays.asList(13, 15, 25), Arrays.asList(13, 15)),
    ...
    _52(52, Arrays.asList(39, 40, 51, 69), Arrays.asList(13, 41, 67, 86)),
    ...
    _164(164, Arrays.asList(147, 148, 178, 179)),
    _165(165, Arrays.asList(149, 151, 179, 180), Arrays.asList(123, 180, 191)),
    _166(166, Arrays.asList(151, 153, 181, 183)),
    _167(167, Arrays.asList(153, 155, 168, 183)),
    _168(168, Arrays.asList(155, 167, 184)),
    _169(169, Arrays.asList(156, 184)),
    _170(170, Arrays.asList(157, 159, 185)),
    _171(171, Arrays.asList(173, 175, 199)),
    _172(172, Arrays.asList(128, 159, 187)),
    _173(173, Arrays.asList(160, 171, 174, 188)),
    _174(174, Arrays.asList(161, 173, 175)),
    _175(175, Arrays.asList(162, 171, 174)),
    _176(176, Arrays.asList(177, 189), Arrays.asList(163, 190)),
    _177(177, Arrays.asList(144, 163, 176)),
    _178(178, Arrays.asList(164, 189, 191)),
    _179(179, Arrays.asList(164, 165, 191)),
    _180(180, Arrays.asList(165, 181, 193), Arrays.asList(153, 165, 184, 190)),
    _181(181, Arrays.asList(166, 180, 182, 193)),
    _182(182, Arrays.asList(181, 183, 195)),
    _183(183, Arrays.asList(166, 167, 182, 196)),
    _184(184, Arrays.asList(168, 169, 185, 196, 197), Arrays.asList(153, 156, 180, 185)),
    _185(185, Arrays.asList(170, 184, 186), Arrays.asList(157, 184, 187), Arrays.asList(128, 153)),
    _186(186, Arrays.asList(159, 185, 198)),
    _187(187, Arrays.asList(172, 188, 198), Arrays.asList(128, 185)),
    _188(188, Arrays.asList(128, 173, 187, 199)),
    _189(189, Arrays.asList(176, 178, 190)),
    _190(190, Arrays.asList(189, 191, 192), Arrays.asList(176, 180, 191)),
    ...
    _198(198, Arrays.asList(159, 186, 187, 199)),
    _199(199, Arrays.asList(171, 188, 198), Arrays.asList(128, 161));
