...
public enum Location {
    ...
    //_1(1, Arrays.asList(8, 9), Arrays.asList(46, 58), Arrays.asList(46)),
    _1(1, Arrays.asList(2, 6), Arrays.asList(3, 5), Collections.singletonList(4)),
    _2(2, Arrays.asList(1, 3), Collections.EMPTY_LIST, Collections.EMPTY_LIST),
    _3(3, Arrays.asList(2, 4), Arrays.asList(1, 5), Collections.EMPTY_LIST),
    _4(4, Arrays.asList(3, 5), Collections.EMPTY_LIST, Collections.singletonList(1)),
    _5(5, Arrays.asList(4, 6), Arrays.asList(1, 3), Collections.EMPTY_LIST),
    _6(6, Arrays.asList(5, 1), Collections.EMPTY_LIST, Collections.EMPTY_LIST);
    /*_7,
    _8,
    _9,
    _10,
    ...
    */
    ...
    Location(int numVal, List<Integer> taxiMoves, List<Integer> busMoves, List<Integer> undergroundMoves) {
        this.numVal = numVal;
        this.taxiMoves = taxiMoves;
        this.busMoves = busMoves;
        this.undergroundMoves = undergroundMoves;
    }
